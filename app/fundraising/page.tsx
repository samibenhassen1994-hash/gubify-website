...
export const metadata: Metadata = {
  title: "Support Gubify | Help Build the Future of Group Organization",
  description:
    "Support the development of Gubify and help us build a better way for groups to organize, collaborate and stay connected.",
  alternates: {
...
export default function FundraisingPage() {
  return (
    <main className="support-page">
      <a className="skip-link" href="#fundraising-main">Skip to content</a>
